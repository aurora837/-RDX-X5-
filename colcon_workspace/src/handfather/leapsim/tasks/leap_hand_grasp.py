...
from leapsim.tasks.leap_hand_rot_pack import LeapHandRot
...
class LeapHandGrasp(LeapHandRot):
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture=None, force_render=None):
        ...
        if "canonical_pose" in cfg["env"]:
            ...
            self.canonical_pose = [
                0.0,0.0,0.0,0.0,-3.14,0.082, 1.244, 0.265, 0.298, 1.104, 1.163, 0.953, -0.138,
    ...
    def reset_idx(self, env_ids):
        ...
        print("leap_hand_dof_pos shape:", self.leap_hand_dof_pos[env_ids, :].shape)
        print("leap_hand_dof_vel shape:", self.leap_hand_dof_vel[env_ids, :].shape)
        print("prev_targets shape:", self.prev_targets[env_ids, :self.num_leap_hand_dofs].shape)
        print("cur_targets shape:", self.cur_targets[env_ids, :self.num_leap_hand_dofs].shape)
        print("")
    ...
    def compute_reward(self, actions):
        ...
        contact_condition = to_torch(contact_list, device="cpu")
